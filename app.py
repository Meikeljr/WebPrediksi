...
# ==================== SECTION: USER AUTH DATA ====================
USERS = {
    "admin": {"password": "admin123", "id": 1, "name": "Admin Penjualan"}
}

# ==================== SECTION: FLASK-LOGIN USER CLASS ====================
...
REFERENCE_CATEGORIES = {"Jenis Kue": "kue_lainnya"}
NUMERIC_VAR = "Tahun"
PERIODE_VAR = "Periode"
UKURAN_VAR = "Ukuran"
...
def drop_reference_category(data):
    ...
    return data_dummies.drop(columns=cols_to_drop, errors='ignore')
...
def build_regression_model(data_path):
    ...
    if X.empty:
        raise ValueError("Model tidak dapat dibangun karena tidak ada variabel independen.")
